...
- **积分续费（.github/workflows/point_renew.yml）**：每月按日历日 `*/7`（如 1/8/15/22/29 日）UTC 00:00 自动执行，支持手动触发
- **仓库保活（.github/workflows/keepalive.yml）**：每月按日历日 `*/14`（如 1/15/29 日）UTC 00:00 自动执行，支持手动触发
